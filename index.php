    ...
    <section class="body">
        ...
        <section class="hero">
            ...
            <div class="row2">
                ...
                <h1 class="home-title">
                    <span>Give your </span>
                    <span>skin protection <br> and cleanliness</span>
                </h1>
                <h1 class="mobile">
                    <span>Give your skin </span>
                    <span>protection and cleanliness</span>
                </h1>
            </div>
        </section>
        ...
        <section>
            <div class="grid">
                <div class="item">
                    <img src="images/korean-girl.png" alt="">
                </div>
                ...
                <div class="item">
                    <img src="images/serum-on-hand.png" alt="">
                </div>
            </div>

            <div class="grid-row3">
                <img class="girl-applying-cream" src="images/girl-applying-cream.png" alt="">
                <div class="grid-text 3">
                    <h1>Become part of our community</h1>
                    <div class="input-container">
                        <button class="arrow"><svg xmlns="http://www.w3.org/2000/svg" width="78" height="13" viewBox="0 0 78 13" fill="none">
                                <path d="M78 6.50001L68 0.726503L68 12.2735L78 6.50001ZM-8.74228e-08 7.5L69 7.50001L69 5.50001L8.74228e-08 5.5L-8.74228e-08 7.5Z" fill="#FFBCBC" />
                            </svg></button>
                        <input type="email" placeholder="example@gmail.com">
                    </div>
                    <img src="images/applying-cream.png" alt="">
                </div>
            </div>
        </section>
    </section>
    <section class="ig">
        ...
        <div class="marquee">
            <ul class="marquee-content">
                <li><img src="images/ig1.png" alt="Image 1"></li>
                <li><img src="images/ig2.png" alt="Image 2"></li>
                <li> <img src="images/ig3.png" alt="Image 3"></li>
                <li><img src="images/ig4.png" alt="Image 4"></li>
                <li> <img src="images/ig5.jpg" alt="Image 5"></li>
                <li><img src="images/girl-applying-cream.png" alt="Image 4"></li>
                <li> <img src="images/hero-product1.png" alt="Image 6"></li>
                <li> <img src="images/applying-cream.png" alt="Image 5"></li>
                <li> <img src="images/rfc1.jpeg" alt="Image 5"></li>
                <li> <img src="images/serum-on-hand.png" alt="Image 5"></li>
            </ul>
        </div>
    </section>
    <?php
