                ...
                <div class="product-details">
                    ...
                    <div class="add-to-cart-opt">
                        <div class="add-to-cart">
                            <button class="plus" onclick="increaseValue()"><i>+</i></button>
                            <input class="num-of-product" id="myInput" type="number" value="1" min="1" max="100" style="padding-right: 11px;">
                            <button class="minus" onclick="decreaseValue()"><i>-</i></button>
                        </div>
