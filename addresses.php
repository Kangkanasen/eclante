        ...
        <div class="floating-form" id="newAddressFormContainer">
            <div class="floating-form-content">
                ...
                <form id="newAddressForm">
                    ...
                    <input type="text" id="newAddress" name="address" required><br><br>
                    <label for="newCity">City:</label>
                    <input type="text" id="newCity" name="city" required><br><br>
                    <label for="newState">State:</label>
                    <input type="text" id="newState" name="state" required><br><br>
                    <label for="newZip">Zip:</label>
                    <input type="text" id="newZip" name="zip" required><br><br>
                    <label for="newPhone">Phone:</label>
                    <input type="text" id="newPhone" name="phone" required><br><br>
                    <button type="submit">Add Address</button>
                    <button type="button" onclick="hideForm('newAddressFormContainer')">Cancel</button>
                </form>
            </div>
        </div>
        ...
        <div class="floating-form" id="editAddressFormContainer">
            <div class="floating-form-content">
                ...
                <form id="editAddressForm">
                    ...
                    <input type="text" id="editState" name="state" required><br><br>
                    ...
                    <button type="button" onclick="hideForm('editAddressFormContainer')">Cancel</button>
                </form>
            </div>
        </div>
